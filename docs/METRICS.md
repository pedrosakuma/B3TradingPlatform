...
| `trading.auth.exchange.requests_total` | Counter | `result`, `reason`, `issuer_alias` | `/auth/exchange` attempts. Reasons are stable RFC codes; no token, raw external subject, user or firm labels (#607). |
